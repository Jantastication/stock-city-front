      ...
      <div>
        <Form onSubmit={e => this.addTransaction(e)}>
          <Form.Input
            ...
            label="Company"
            name="companySymbol"
            value={this.props.company["symbol"]}
            readOnly
          />
          <Form.Input
            fluid
          ...
          <Form.Input
            ...
            name="pricePerShare"
            value={
              this.props.currentPrice.close
                ? this.props.currentPrice.close
                : this.props.chart[this.props.chart.length - 1].close
            }
            readOnly
          />
          ...
          <Button onClick={console.log("purchased")} type="submit">
            Confirm Purchase
          </Button>
        </Form>
      </div>
